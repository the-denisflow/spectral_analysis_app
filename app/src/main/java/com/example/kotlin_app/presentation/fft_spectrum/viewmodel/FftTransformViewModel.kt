...
@HiltViewModel
class FftTransformViewModel @Inject constructor(private val micBufferRepository: MicBufferRepository) :
    ViewModel() {
    private val _transformedData = MutableStateFlow<ShortArray>(ShortArray(0))
    val transformedData: StateFlow<ShortArray> = _transformedData
